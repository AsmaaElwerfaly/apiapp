    ...
    <ul class="navbar-nav flex-fill w-100 mb-2">
      ...
      <li class="nav-item dropdown">
        ...
        <ul class="collapse list-unstyled pl-4 w-100" id="charts">
          ...
          <li class="nav-item">
            <a class="nav-link pl-3" href="{{asset('backend/chart-chartjs.html')}}"><span class="ml-1 item-text">Chartjs</span></a>
          </li>
          <li class="nav-item">
            <a class="nav-link pl-3" href="{{asset('backend/chart-apexcharts.html')}}"><span
